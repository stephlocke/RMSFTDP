...
# Misc. install instructions {.tabset}
<!-- Source: github.com/stephlocke/Rtraining/inst/handouts/infrastructure/setting-up-a-windows-r-machine -->
This section outlines some general installation notes - not necessarily ones that need to be followed for the data science VM but may prove useful generally

## ODBC Driver
Get the relevant [SQL Server ODBC 11 Preview](https://blogs.msdn.microsoft.com/joseph_idzioreks_blog/2015/09/13/azure-sql-database-sqlcmd-and-bcp-on-ubuntu-linux/) driver for your OS and install it. You can't currently use the native drivers when connecting from R.
