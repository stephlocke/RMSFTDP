...
## Prerequisites
Attendees should be comfortable writing SQL and will ideally having coded a bit in other languages previously. Attendees will need a laptop with:
- R
- R Tools (if using Windows)
- SQL Server ODBC Driver 13
- An IDE
    + Rstudio
    + Visual Studio plus Visual Studio R Tools
